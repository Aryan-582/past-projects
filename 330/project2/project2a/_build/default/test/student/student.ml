...
let test_area _ =
  ...
  assert_equal 1 (area (2, 2) (1, 1)) ~msg:"area (2)";
...
let test_volume _ =
  ...
  assert_equal 1 (volume (2, 2, 2) (1, 1, 1)) ~msg:"volume (2)";
  assert_equal 4 (volume (1, 1, 1) (3, 2, 3)) ~msg:"volume (3)";
  assert_equal 4 (volume (1, 1, 1) (3, 3, 2)) ~msg:"volume (4)";
  assert_equal 8 (volume ((-1), (-1), (-1)) (1, 1, 1)) ~msg:"volume (5)"
...
let test_larger _ =
  ...
  assert_equal [] (larger [1] [1]) ~msg:"larger (5)"
...
let test_rotate _ =
  assert_equal [1;2;3] (rotate 0 [1;2;3]) ~msg:"rotate (2)";
  assert_equal [2; 3; 4; 1] (rotate 5 [1; 2; 3; 4]) ~msg:"merge (3)"
