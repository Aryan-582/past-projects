...
let test_nfa_move _ =
  ...
  assert_nfa_move m2 [] (Some 'a') [] ;
  let m3 =
    { qs= [0; 1; 2]
    ; sigma= ['a'; 'b']
    ; q0= 0
    ; fs= [2]
    ; delta= [(0, Some 'a', 1); (1, Some 'a', 2)] }
  in
  assert_nfa_move m3 [0;1] (Some 'a') [1;2] ;
  assert_nfa_move m3 [1] (Some 'a') [2] ;
  assert_nfa_move m3 [2] (Some 'a') [] ;
  assert_nfa_move m3 [0] (Some 'b') [] ;
  ...
  let m4 =
    ...
    ; q0= 0
    ; fs= [2]
    ; delta= [(0, None, 1); (0, Some 'a', 2); (1, None, 2)] }
  in
  assert_nfa_move m4 [0;1;2] (None) [1;2] ;
  assert_nfa_move m4 [1] (Some 'l') [] ;
